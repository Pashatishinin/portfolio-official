...
document.addEventListener("DOMContentLoaded", () => {
	...
	const rtA = new THREE.WebGL3DRenderTarget(width, height, options);
	const rtB = new THREE.WebGL3DRenderTarget(width, height, options);
	...
	const simMaterial = new THREE.ShaderMaterial({
		...
		vertexShader: simulationVertesShader,
    ...
    ctx?.fillText("softhorizone", width / 2, height / 2);
